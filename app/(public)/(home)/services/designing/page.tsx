...
import { designTypes, faqs, processSteps, whyChooseUs } from "./_components/data"
...
export default function Design() {
    ...
    const [selectedService, setSelectedService] = useState<typeof designTypes[0] | null>(null)
    const [isDialogOpen, setIsDialogOpen] = useState(false)

    useEffect(() => {
        const interval = setInterval(() => {
            setActiveService((prev) => (prev + 1) % designTypes.length)
        }, 6000)
        return () => clearInterval(interval)
    }, [])

    const handleServiceClick = (service: typeof designTypes[0], index: number) => {
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <h1 className="text-4xl md:text-4xl lg:text-5xl font-black text-gray-900 leading-tight tracking-tight mb-6">
                                    <span className="block whitespace-nowrap">Designs That Speak</span>
                            ...
                            <div className="space-y-4">
                                <p className="text-lg md:text-xl text-gray-700 leading-relaxed font-light">
                                    We create <span className="font-semibold text-[#B944EA]">impactful visual identities</span> that captivate, connect, and convert.
                                </p>
                                <p className="text-lg text-gray-600 leading-relaxed">
                                    From concept to final design, we bring your brand vision to life with creativity, strategy, and precision.
                                </p>
                            </div>
                        ...
                        <div className="relative">
                            <div className="relative">
                                ...
                                <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                                    <Image 
                                        src="/Designing/Hero section.jpg" 
                                        alt="Design Services" 
                                        width={600}
                                        height={450}
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-5xl font-bold text-gray-900 mb-6">Our Design Services</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Tailored design services that transform ideas into impactful visual experiences.
                        </p>
                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-12 items-center">
                                    <div>
                                        <div className="text-4xl mb-6 flex items-center gap-2">
                                            {designTypes[activeService].icon}
                                            <h3 className="text-3xl font-bold text-gray-900">
                                                {designTypes[activeService].title}
                                            </h3>
                                        </div>
                                        <p className="text-lg text-gray-600 leading-relaxed">
                                            {designTypes[activeService].description}
                                        </p>
                                    </div>
                                    <div className="relative">
                                        <div className="aspect-video rounded-3xl overflow-hidden shadow-2xl">
                                            <Image 
                                                src={designTypes[activeService].image} 
                                                alt={designTypes[activeService].title}
                                                width={800}
                                                height={600}
            ...
            <section className="py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-20">
                        <h2 className="text-5xl font-bold text-gray-900 mb-6">From Concept to Creation</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            A streamlined approach that transforms ideas into designs that inspire, engage, and deliver exceptional results.
                        </p>
                    </div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                                            <Image 
                                                src={
                                                    index === 0 
                                                        ? "/Designing/process step 1.jpg"
                                                        : index === 1
                                                        ? "/Designing/process step 2.jpg"
                                                        : "/Designing/process step 3.jpg"
                                                }
                                                alt={step.title}
                                                width={800}
                                                height={600}
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-12 leading-relaxed">
                        We transform ideas into impactful visuals—logos, collaterals, and digital assets—that elevate brands and create lasting impressions with purposeful, precise, and creative design.
                    </p>

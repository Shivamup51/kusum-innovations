...
import { paidAdvertisingTypes, faqs, processSteps, whyChooseUs } from "./_components/data"
...
export default function PaidAdvertising() {
    ...
    const [selectedService, setSelectedService] = useState<typeof paidAdvertisingTypes[0] | null>(null)
    const [isDialogOpen, setIsDialogOpen] = useState(false)

    useEffect(() => {
        const interval = setInterval(() => {
            setActiveService((prev) => (prev + 1) % paidAdvertisingTypes.length)
        }, 6000)
        return () => clearInterval(interval)
    }, [])

    const handleServiceClick = (service: typeof paidAdvertisingTypes[0], index: number) => {
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight tracking-tight mb-6">
                                    <span className="block whitespace-nowrap">Ads That Deliver</span>
                            ...
                            <div className="space-y-4">
                                <p className="text-lg md:text-xl text-gray-700 leading-relaxed font-light">
                                    We craft <span className="font-semibold text-[#B944EA]">high-performing paid campaigns</span> that captivate, convert, and maximize ROI.
                                </p>
                                <p className="text-lg text-gray-600 leading-relaxed">
                                    From strategy to optimization, we bring your brand to life with creativity, precision, and measurable impact.
                                </p>
                            </div>
                        ...
                        <div className="relative">
                            <div className="relative">
                                ...
                                <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                                    <Image 
                                        src="/PAID ADVERTISING/Hero section.jpg" 
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
                        ...
                        <div className="relative">
                            <div className="h-full rounded-3xl overflow-hidden shadow-2xl">
                                <Image 
                                    src="/PAID ADVERTISING/introduction.jpg" 
                                    alt="Our Story - Paid Advertising Team" 
                                    width={600}
                                    height={550}
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-5xl font-bold text-gray-900 mb-6">Our Paid Advertising Services</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Strategic campaigns across all major platforms designed to maximize your ROI and reach.
                        </p>
                    </div>
                    ...
                    <div className="mb-12 lg:hidden">
                        <div className="flex flex-nowrap overflow-x-auto justify-start gap-4 px-4 pb-2 service-tabs-scroll">
                            {paidAdvertisingTypes.map((service, index) => (
                                <button
                                    key={index}
                                ...
                                <div className="grid grid-cols-1 gap-12 items-center">
                                    <div>
                                        <div className="text-4xl mb-6 flex items-center gap-2">
                                            {paidAdvertisingTypes[activeService].icon}
                                            <h3 className="text-3xl font-bold text-gray-900">
                                                {paidAdvertisingTypes[activeService].title}
                                            </h3>
                                        </div>
                                        <p className="text-lg text-gray-600 leading-relaxed">
                                            {paidAdvertisingTypes[activeService].description}
                                        </p>
                                    </div>
                                    <div className="relative">
                                        <div className="aspect-video rounded-3xl overflow-hidden shadow-2xl">
                                            <Image 
                                                src={paidAdvertisingTypes[activeService].image} 
                                                alt={paidAdvertisingTypes[activeService].title}
                                                width={800}
                                                height={600}
            ...
            <section className="py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            A proven process that transforms ad spend into measurable business growth.
                        </p>
                    </div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                                            <Image 
                                                src={
                                                    index === 0 
                                                        ? "/PAID ADVERTISING/step 1.jpg"
                                                        : index === 1
                                                        ? "/PAID ADVERTISING/step 2.jpg"
                                                        : "/PAID ADVERTISING/step 3.jpg"
                                                }
                                                alt={step.title}
                                                width={800}
                                                height={600}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
                        ...
                        <div className="relative">
                            <div className="h-full rounded-3xl overflow-hidden shadow-2xl">
                                <Image 
                                    src="/PAID ADVERTISING/why choose us.jpg" 
                                    alt="Our Team" 
                                    width={800}
                                    height={450}
                                    className="w-full h-full object-cover"
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-12 leading-relaxed">
                        We create high-performing campaigns that transform ad spend into real business results.
                    </p>

...
export const faqs = [
    {
        question: "What types of photography services do you offer in Delhi NCR?",
        answer: "We offer a wide range of professional photography services including creative photoshoots, food photography, ecommerce product shoots, 360-degree photography, interior and exterior architecture photography, product photography, and corporate photoshoots."
    },
    {
        question: "Do you provide on-location shoots or only studio photography?",
        answer: "Yes, we provide both studio and on-location shoots across PAN India. Whether you need a product shoot at our studio or an interior shoot at your site, we bring the setup wherever it's needed."
    },
    {
        question: "How much do your photography services cost?",
        answer: "Our pricing depends on the type of photography, shoot duration, number of images, and post-production requirements. We offer competitive and flexible packages—contact us for a customized quote."
    },
    {
        question: "Can you help with styling and creative direction for shoots?",
        answer: "Absolutely! We offer complete creative support including concept development, styling, set design, and art direction to ensure the shoot aligns perfectly with your brand vision."
    },
    {
        question: "How long does it take to deliver the final edited photos?",
        answer: "Turnaround time typically ranges from 2 to 7 working days, depending on the complexity and volume of the shoot. We are able to accommodate urgent projects upon request."
    },
    {
        question: "Do you offer ecommerce-specific product photography for platforms like Amazon or Flipkart?",
        answer: "Yes, we specialize in ecommerce product photography tailored for Amazon, Flipkart, Myntra, and other platforms—following all platform-specific image guidelines and quality standards."
    },
    {
        question: "Do you provide 360-degree or virtual tour photography for products and spaces?",
        answer: "Yes, we offer 360-degree product photography and virtual tours for real estate, retail stores, and ecommerce—perfect for creating immersive, interactive experiences for your customers."
    },
    {
        question: "Can I book multiple types of photography in a single project?",
        answer: "Definitely! Many of our clients combine services like product photography with lifestyle or interior shots. We create bundled packages for efficient execution and cohesive visual output."
    }
]
...
export const processSteps = [
    {
        ...
        description: "Every impactful photoshoot begins with a clear concept. We brainstorm ideas, research brand objectives, and plan styling and setups that align with your goals. This ensures visuals are purposeful, original, and effective.",
        icon: Lightbulb,
        color: "from-blue-500 to-purple-600",
        bgColor: "bg-blue-50",
        features: [
            "Concept Development & Storyboarding",
            "Styling & Shoot Planning",
            "Brand Research & Mood Boards"
        ]
    },
    {
        step: "02", 
        title: "Shoot Execution",
        description: "This is where vision meets reality. With professional equipment, lighting, and direction, we capture moments that reflect your identity. From framing to composition, every detail is crafted to communicate your story.",
        icon: Camera,
        ...
        features: [
            ...
            "Expert Direction & Composition"
        ]
    },
    {
        step: "03",
        title: "Finalization & Delivery", 
        description: "We refine every image with precision edits, ensuring they are polished and aligned with your brand identity. The final output is delivered in high-resolution, optimized formats—ready to impress across print and digital platforms.",
        icon: Zap,
        color: "from-pink-500 to-red-600",
        bgColor: "bg-pink-50",
        features: [
            "Professional Retouching & Editing",
            "High-Resolution, Optimized Files",
...
export const whyChooseUs = [
    ...
    "End-to-end creative direction & styling",
    "Studio & on-location shoots available",
    "Strong focus on brand storytelling",
    "Fast turnaround & high-quality edits",
    "Affordable packages for startups & enterprises",
    "Customized, client-first solutions",
    "Consistent support from idea to final delivery"
]

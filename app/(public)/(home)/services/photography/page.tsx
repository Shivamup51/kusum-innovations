...
export default function Photography() {
    ...
    const [selectedService, setSelectedService] = useState<typeof photographyTypes[0] | null>(null)
    ...
    const handleServiceClick = (service: typeof photographyTypes[0], index: number) => {

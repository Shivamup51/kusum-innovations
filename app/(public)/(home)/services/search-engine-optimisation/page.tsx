...
export default function SEO() {
    ...
    const [selectedService, setSelectedService] = useState<typeof seoTypes[0] | null>(null)
    ...
    const handleServiceClick = (service: typeof seoTypes[0], index: number) => {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
                        ...
                        <div>
                            <h2 className="text-5xl font-bold text-gray-900 mb-8 leading-tight">
                                Visibility That Speaks Volumes
                            </h2>

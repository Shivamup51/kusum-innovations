...
export const processSteps = [
    {
        ...
        description: "Every powerful video begins with a solid plan. At Kusum Innovations, we believe pre-production is the backbone of storytelling. We brainstorm concepts, conduct research, finalize scripts, select ideal locations, and craft detailed storyboards—ensuring every detail aligns with your brand's goals. This foundation ensures your vision comes to life flawlessly.",
        icon: Edit3,
    ...
    },
    {
        step: "02", 
        title: "Production",
        description: "Lights. Camera. Action. This is where your story comes alive. Once scripts and storyboards are approved, our expert crew shoots with high-end cameras, professional lighting, and sound equipment—ensuring every frame reflects your brand's essence with cinematic precision. Every shot is crafted to inspire and leave a lasting impression.",
        icon: Camera,
    ...
    },
    {
        ...
        description: "Here's where the magic truly happens. Our skilled editors meticulously bring visuals, audio, sound effects, and dynamic graphics together to create a seamless, engaging final product. From color grading to precision sound design and visual effects, we polish every frame to perfection—delivering videos that captivate and inspire.",
        icon: Zap,

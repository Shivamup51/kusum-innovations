        ...
        <section className="py-24 relative overflow-hidden bg-gradient-to-br from-gray-50 to-white">
            ...
            <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                    Take the first step toward impactful growth. Whether you&apos;re building a brand, creating videos, or scaling online — Kusum Innovations is ready to partner with you.
                </p>
